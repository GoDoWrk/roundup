...
class PipelineStats(Base):
    ...
    cluster_candidates_same_topic_total: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    cluster_candidates_cross_topic_rejected_total: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    cluster_entity_overlap_attach_total: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    cluster_entity_conflict_rejected_total: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    cluster_no_candidate_new_total: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    cluster_topic_lane_attach_total: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    cluster_topic_lane_new_total: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
